...
public extension Face {
    ...
    public static func lettersFace() -> Face {
        return Face(identifier: Identifier.Letters, rows: [
            ...
            Row(keys: [
                Key(label: .Icon("shift"), value: .Action(.Shift), length: 13.00, style: .Alternate),
                ...
                Key(label: .Icon("backspace"), value: .Action(.Backspace), length: 13.00, style: .Alternate),
            ]),
            Row(keys: [
                Key(label: .Char("123"),    value: .Action(.ChangeFace(Identifier.Numbers)), length: 13.00, style: .Alternate),
                Key(label: .Icon("globe"),  value: .Action(.Globe),                          length: 10.00, style: .Alternate),
    ...
    public static func charactersFace() -> Face {
        return Face(identifier: Identifier.Characters, rows: [
            ...
            Row(keys: [
                Key(label: "_",        char: "_",        length: 10.00),
                Key(label: "\\",       char: "\\",       length: 10.00),
                Key(label: "|",        char: "|",        length: 10.00),
                Key(label: "~",        char: "~",        length: 10.00),
                Key(label: "<",        char: "<",        length: 10.00),
